...
function updateStatsOnWin(level, isPerfect) {
    ...
    if (currentBest < 100) {
        ...
        // Reward completed level with +100 PLO Coins
...
function buyUnlockLevel(level, cost) {
    if (UI_STATE.ploCoins >= cost) {
        ...
        alert("Not enough PLO Coins to unlock this level! Keep racing.");
    }
}
...
function selectSkin(skinId) {
    ...
    if (isOwned) {
        ...
        if (UI_STATE.ploCoins >= skin.cost) {
            ...
            alert("Insufficient PLO Coins! Keep playing to earn more.");
        }
    }
